				      ...
				      <div class="col-md-9 personal-info">
				        ...
				        <form class="form-horizontal" role="form" method="post">
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-lg-8">
				              <input class="form-control" type="text" name="teacherid" value="<?php if (isset($_GET['id'])) { print $sname; }?>">
				            </div>
				          </div>
				          <div class="form-group">
				          ...
				          <div class="form-group">
				            ...
				            <div class="col-md-8">
				              <input class="form-control" type="text"  name="experience" value="<?php if (isset($_GET['id'])) { print $pass; }?>">
				            </div>
				          </div>
				          <div class="form-group">
...
<?php 
	if(isset($_POST['submit'])) {
		if (isset($_GET['id'])) {
			...
			$sname1 = mysqli_real_escape_string($conn, $_REQUEST['teacherid']);
			$email1 = mysqli_real_escape_string($conn, $_REQUEST['email']);
			$phone1 = mysqli_real_escape_string($conn, $_REQUEST['phone']);
			$sem1 = mysqli_real_escape_string($conn, $_REQUEST['experience']);

			$query = "UPDATE teachers SET name='$name1', teacherid='$sname1', email='$email1', phone='$phone1', experience='$sem1' WHERE teacherid='$user'";
