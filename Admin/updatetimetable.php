...
<body>
    <div class="container">
        <div class="card mt-3">
        <div class="card-body">
	<form action="update_timetable_action.php"  method="POST">
		<table>
...
<?php
            ...
            if(isset($_GET['success']) && $_GET['success']== "yes"){
                    ...
                    <div class="alert alert-success m-5 " role="alert"> Updated 
                        Successfully
                    </div>
...
<span class="input-group-text text-white bg-success">Subjects:</span>
...
<label class="input-group-text text-white bg-success">Select Lecture Time:</label>
